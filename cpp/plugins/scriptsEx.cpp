...
tjs_error Try_iTJSDispatch2_PropGet(iTJSDispatch2 *_this, tjs_uint32
flag,
                                    const tjs_char *membername, tjs_uint32
                                    *hint,
...
tjs_error Try_iTJSDispatch2_PropGetByNum(iTJSDispatch2 *_this, tjs_uint32
flag,
                                         tjs_int num, tTJSVariant
                                         *result,
                                         iTJSDispatch2 *objthis
) {
...
tjs_error Try_iTJSDispatch2_PropSet(iTJSDispatch2 *_this, tjs_uint32
flag,
                                    const tjs_char *membername, tjs_uint32
                                    *hint,
                                    const tTJSVariant *param, iTJSDispatch2
                                    *objthis) {
...
tjs_error Try_iTJSDispatch2_PropSetByNum(iTJSDispatch2 *_this, tjs_uint32
flag,
                                         tjs_int num,
                                         const tTJSVariant *param, iTJSDispatch2
                                         *objthis) {
...
public:
    ...
    FuncCall( // function invocation
            ...
            const tjs_char *membername,// member name ( NULL for a default member )
            tjs_uint32
            *hint,            // hint for the member name (in/out)
            tTJSVariant *result,        // result
            tjs_int
...
ScriptsAdd::getKeys(tTJSVariant
                    *result,
                    tjs_int numparams,
                    tTJSVariant
                    **param,
 ...
 */
tjs_error TJS_INTF_METHOD
ScriptsAdd::getCount(tTJSVariant
                     *result,
                     tjs_int numparams,
                     tTJSVariant
                     **param,
 ...
 */
tTJSVariant
ScriptsAdd::getObjectContext(tTJSVariant
                             obj) {
    iTJSDispatch2 *objthis = obj.AsObjectClosureNoAddRef().ObjThis;
    return
            tTJSVariant(objthis, objthis
            );
}
 ...
 */
bool
ScriptsAdd::isNullContext(tTJSVariant
                          obj) {
    return obj.
...
// 構造体比較関数
bool
ScriptsAdd::equalStruct(tTJSVariant
                        v1,
                        tTJSVariant v2
) {
// タイプがオブジェクトなら特殊判定
...
// 関数どうしなら特別扱いで関数比較
        if (o1.IsInstanceOf(0, NULL, NULL, TJS_W("Function"), NULL) ==
            TJS_S_TRUE
            && o2
                       .IsInstanceOf(0, NULL, NULL, TJS_W("Function"), NULL) == TJS_S_TRUE)
            return v1.
                    DiscernCompare(v2);

// Arrayどうしなら全項目を比較
        if (o1.IsInstanceOf(0, NULL, NULL, TJS_W("Array"), NULL) ==
            TJS_S_TRUE
            && o2
                       .IsInstanceOf(0, NULL, NULL, TJS_W("Array"), NULL) == TJS_S_TRUE) {
// 長さが一致していなければ比較失敗
...
// 全項目を順番に比較
            ...
            for (
                    ...
                    i++) {
                (void) o1.
                        PropGetByNum(TJS_IGNOREPROP, i, &o1Val, NULL
                );
                (void) o2.
                        PropGetByNum(TJS_IGNOREPROP, i, &o2Val, NULL
                );
                if (!
                        equalStruct(o1Val, o2Val
                        ))
                    return false;
            }
            return true;
...
// Dictionaryどうしなら全項目を比較
        if (o1.IsInstanceOf(0, NULL, NULL, TJS_W("Dictionary"), NULL) ==
            TJS_S_TRUE
            && o2
                       .IsInstanceOf(0, NULL, NULL, TJS_W("Dictionary"), NULL) == TJS_S_TRUE) {
// キー一覧が一致してなければ比較失敗
            tTJSVariant k1, k2;
            _getKeys(&k1, v1
            );
...
// 全項目を順番に比較
            ...
            tTJSVariant(o1
                                .
                                        EnumMembers(TJS_IGNOREPROP, &closure, NULL
                                ));
...
// 構造体比較関数(数字の比較はゆるい)
bool
ScriptsAdd::equalStructNumericLoose(tTJSVariant
                                    v1,
                                    tTJSVariant v2
) {
// タイプがオブジェクトなら特殊判定
...
// 全項目を順番に比較
            ...
            for (
                ...
                if (!
                        equalStructNumericLoose(o1Val, o2Val
                        ))
                    return false;
            }
            return true;
...
// 項目数が一致していなければ比較失敗
            ...
            (void) o1.
                    GetCount(&o1Count, NULL, NULL, NULL
            );
            (void) o2.
                    GetCount(&o2Count, NULL, NULL, NULL
            );
            if (o1Count != o2Count)
                return false;
// 全項目を順番に比較
            DictMemberCompareNumericLooseCaller *caller = new DictMemberCompareNumericLooseCaller(
                    o2);
            tTJSVariantClosure closure(caller);
            tTJSVariant(o1
                                .
...
// 全配列・辞書巡回
tjs_error TJS_INTF_METHOD
ScriptsAdd::foreach(tTJSVariant
                    *result,
                    tjs_int numparams,
                    tTJSVariant
                    **param,
...
// 配列の場合
    if (obj.IsInstanceOf(0, NULL, NULL, TJS_W("Array"), NULL) == TJS_S_TRUE) {
        ...
        for (
            ...
            (void) obj.
                    PropGetByNum(TJS_IGNOREPROP, i, &value, NULL
            );
 ...
 */
tjs_error TJS_INTF_METHOD
ScriptsAdd::getMD5HashString(tTJSVariant
                             *result,
                             tjs_int numparams,
                             tTJSVariant
                             **param,
...
public:
    ...
    FuncCall( // function invocation
        ...
        dict->PropSet(TJS_MEMBERENSURE | (tjs_int) *param[1], param[0]->GetString(), 0, &value,
                      dict);
        if (result)
            *result = true;
        return TJS_S_OK;
...
// Arrayの複製
        if (o1.IsInstanceOf(0, NULL, NULL, TJS_W("Array"), NULL) == TJS_S_TRUE) {
            ...
            for (
                    ...
                    i++) {
                (void) o1.
                        PropGetByNum(TJS_IGNOREPROP, i, &val, NULL
                );
...
// フラグ指定つきプロパティ操作
tjs_error TJS_INTF_METHOD
ScriptsAdd::propSet(tTJSVariant
                    *result,
                    tjs_int numparams,
                    tTJSVariant
                    **param,
    ...
    return ((param[1]->
            ...
            Try_iTJSDispatch2_PropSet(clo
                    ...
                    GetString(), param[1]
                                              ...
                                              .ObjThis)
            :
            Try_iTJSDispatch2_PropSetByNum(clo
                                                   .Object, flag, param[1]->

                    operator tjs_int(), param[2], clo

                                                   .ObjThis));
}

tjs_error TJS_INTF_METHOD
ScriptsAdd::propGet(tTJSVariant
                    *result,
                    tjs_int numparams,
                    tTJSVariant
                    **param,
    ...
    return ((param[1]->
            ...
            Try_iTJSDispatch2_PropGet(clo
                    ...
                    GetString(), param[1]
                                              ...
                                              .ObjThis)
            :
            Try_iTJSDispatch2_PropGetByNum(clo
                                                   .Object, flag, param[1]->

                    operator tjs_int(), result, clo
...
// (const)つき辞書／配列を安全に評価
tjs_error TJS_INTF_METHOD
ScriptsAdd::safeEvalStorage(tTJSVariant
                            *result,
 ...
 */
    ...
    memmove(top
            + 8, top, sizeof(tjs_char) * length); // xxxxxxxx<buffer>x
    memcpy(top, TJS_W("(const)["),
           sizeof(tjs_char) * 8);      // (const)[<buffer>x
    memcpy(top
           + 8 + length, TJS_W("]"), sizeof(tjs_char) * 1);      // (const)[<buffer>]
    buffer.
...
//TVPAddLog(buffer);
    ...
    tTJSVariant temp;
    TVPExecuteExpression(buffer, shortname,
                         0, context, &temp);
    if (result) {
